...
import {TouchableOpacity, Pressable, StyleSheet, Dimensions, View, Text,
    ToastAndroid, Image, ImageBackground, StatusBar, Alert,Share} from 'react-native'
    ...
    const onShare = async () => {
        try {
          const result = await Share.share({
           title: 'FlylightCrm Admin',
           message: 'FlylightCrm Admin App , AppLink :https://play.google.com/store/apps/details?id=com.fliylight&hl=en', 
             url: 'https://play.google.com/store/apps/details?id=com.fliylight&hl=en'
          });
